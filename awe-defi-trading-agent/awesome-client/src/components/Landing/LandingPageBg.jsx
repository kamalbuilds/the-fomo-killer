    ...
    const render = () => {
      ...
      particles.forEach((p1) => {
        particles
          .filter(
            (p2) =>
              p1 !== p2 && distance(p1.x, p1.y, p2.x, p2.y) < p1.connectDistance
          )
          .forEach((p2) => {
            ...
            const opacity =
            Math.floor((100 / p1.connectDistance) * (p1.connectDistance - dist)) /
            100
            ...
            const grayValue = Math.floor(lerp(255, 102, 1 - colorSwing)) 
